...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
    	<div class="header">
        	<a href="<?php echo $url_home; ?>"><img src="<?php echo $design; ?>/images/logo.png" alt="Foro" /></a>
	    </div>
        <div class="content">
<?php
...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Inicio</a>
    </div>
	<div class="box_right">
...
<div class="box">
	<div class="box_left">
    	<a href="<?php echo $url_home; ?>">Home del Foro</a>
    </div>
	<div class="box_right">
    	<a href="signup.php">Registrate</a> - <a href="login.php">Login</a>
    </div>
	<div class="clean"></div>
</div>
<?php
...
<table class="categories_table">
	<tr>
    	...
    	<th class="forum_ntop">Tópicos</th>
